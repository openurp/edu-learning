...
<script>
 ...
 [#list semesterGrades?keys as s]
   ...
   [/#list]
 [/#list]
 require(["${b.base}/static/raphael/raphael-min.js"], function( Raphael ) {
   require(["${b.base}/static/raphael/g.raphael-min.js"], function( a1 ) {
     require(["${b.base}/static/raphael/g.line-min.js"], function( a1 ) {
      drawDigram();
     });
   });
 });
