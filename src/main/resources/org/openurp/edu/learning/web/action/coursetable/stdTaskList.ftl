[#ftl]
[@b.grid items=taskList?sort_by(["course","code"]) var="clazz" sortable="false" class="border-1px border-colored"]
  [@b.row]
    ...
    [@b.col width="20%" property="course.name" title="课程名称"]
       [@b.a href="clazz?clazz.id=" + clazz.id title="查看课程详情"]${clazz.course.name}[/@]
    [/@]
