...
val openurp_edu_api = "org.openurp.edu" % "openurp-edu-api" % "0.31.0.Beta1"
val openurp_stater_web = "org.openurp.starter" % "openurp-starter-web" % "0.2.7"
val openurp_base_tag = "org.openurp.base" % "openurp-base-tag" % "0.2.6"
